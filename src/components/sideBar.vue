<template>
    <div class="SideBarHome" >
        <div class="sidebar h-full bg-gray-800" :class="{ hide:sideBarClosed }">
        <div class="title capitalize h-[50px] m-5 sticky top-0 left-0 z-[100] bg-gray-800"><a href="" class="flex justify-center items-center text-2xl font-bold text-blue-50 tracking-wide "> <i class="fa-solid fa-face-smile"></i>  adminPanal</a></div>
        <div class="toggle-menu" @click="toggleSideBar">
            <i class='bx bx-menu toggle-sidebar text-lg cursor-pointer'></i>
        </div>
        <ul class="sidebar-menu">
            <li class="cursor-pointer capitalize"><a href="#"><i class="fa-solid fa-house"></i> home</a></li>
            <li class="cursor-pointer capitalize"><a href="#" class="active"><i class="fa-solid fa-grip"></i> dashboard</a></li>
            <li class="divider text-gray-200 flex justify-start" data-text="main">Main</li>
            <li  @click.prevent="isActive=!isActive" class="cursor-pointer capitalize">
                <a :class="{ active: isActive }"  href=""><i class="fa-solid fa-inbox"></i> elements <i :class="{ active: isActive }" class="icon-right fa-solid fa-circle-chevron-right"></i></a>
             ...
             <li class="cursor-pointer capitalize"><a href="#"><i class='bx bxs-widget'></i> widgets</a></li>
             <!-- <li class="driver cursor-pointer capitalize">table and forms</li> -->
             <li class="cursor-pointer capitalize"><a href="#"><i class="fa-solid fa-table"></i> tables</a></li>
